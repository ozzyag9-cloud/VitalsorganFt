      ...
      >
        <div className="flex justify-between items-start sticky top-0 bg-[#05070c]/80 backdrop-blur-md pb-6 z-20 border-b border-white/5">
           <div className="space-y-3">
              ...
              <p className="text-[12px] text-indigo-500 uppercase tracking-[0.4em] font-black italic">Production Orchestration & Governance Protocol</p>
           </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
           <div className="space-y-12">
              <section className="space-y-6">
                 <h3 className="text-xs font-black text-white uppercase tracking-[0.4em] flex items-center gap-4">
                    <div className="w-8 h-8 bg-indigo-500/10 rounded-xl flex items-center justify-center text-xs text-indigo-400 border border-indigo-500/20">01</div>
              ...
              <section className="space-y-6">
                 <h3 className="text-xs font-black text-white uppercase tracking-[0.4em] flex items-center gap-4">
                    <div className="w-8 h-8 bg-indigo-500/10 rounded-xl flex items-center justify-center text-xs text-indigo-400 border border-indigo-500/20">02</div>
                    Token & DAO Deployment
                 </h3>
                  <div className="bg-slate-900/50 p-8 rounded-3xl border border-indigo-500/20 space-y-6">
                       ...
                       <div className="flex gap-4">
                          ...
                          <div className="space-y-2">
                             ...
                             <p className="text-[10px] text-slate-500 leading-relaxed">
                                Use the <code className="text-indigo-400">spl-token create-token</code> command to initialize the fixed 1.0B supply. For the DAO, deploy a Realms (Open-source) governance shell to manage the treasury.
                             </p>
                          </div>
                       </div>
           ...
           <div className="space-y-12">
              <section className="space-y-6">
                 <h3 className="text-xs font-black text-white uppercase tracking-[0.4em] flex items-center gap-4">
                    <div className="w-8 h-8 bg-indigo-500/10 rounded-xl flex items-center justify-center text-xs text-indigo-400 border border-indigo-500/20">03</div>
